...
# Own modules
from embedimg import logging_conf
from embedimg import errors
from embedimg import utils
from embedimg import config_loader
...
def argument_parser() -> argparse.ArgumentParser:
    ...
    """
    parser = argparse.ArgumentParser(description="embedimg")
    parser.add_argument("-v", "--version", action="store_true", help="print out embedimg version and exit").completer = EC
    parser.add_argument("--autoconfig", action="store_true", help="Configure embedimg automatically").completer = EC
    return parser
